...
export default function Home() {
  return (
    <div className="relative h-screen overflow-hidden home bg-fixed bg-cover bg-center pb-5">
        <div className=" relative flex-col z-10 flex items-center px-12 py-32 mx-auto md:px-12 xl:py-40" >
          {/* <div className="relative z-10 flex flex-col items-start lg:w-3/5 xl:w-2/5">
            <span className="font-bold sm:text-3xl text-blue-800">Veeramani Rajkumar</span>
          ...
          <div class="flex flex-col font-mono">
                <img src="/images/veera.jpg" class="mx-auto rounded-full w-28"/>
                {/* <p class="my-6 text-3xl text-center dark:text-white">
                    Hi, I&#x27;m Veeramani Rajkumar 🤘
                </p> */}
...
<main class="relative h-screen overflow-hidden font-mono home bg-fixed bg-cover bg-center  dark:bg-gray-800">
